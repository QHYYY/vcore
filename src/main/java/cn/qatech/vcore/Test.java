 ...
 * @Description:TODO
 * @Author:qihaoyuan
 * @Date:Create：in2020/10/23　10:55
 * @ClassName:Test
 */
public class Test {
    public static void main(String[] args) {
        try {
            List<File> fileList = getAllFile("C:\\Users\\31429\\Desktop\\精简资产");
            ...
            for (File file : fileList) {
                ...
                for (XSSFSheet sheet : sheets) {
                    for (int i = 1; i < sheet.getLastRowNum(); i++) {
                        ...
                        String deviceName = cell1.getStringCellValue();
                        String vendor = cell3.getStringCellValue();
                        if (vendor.equals("Private")) {
                            vendor = "DAHUA";
                        }
            ...
            FileOutputStream outputStream = new FileOutputStream("D:\\rules\\result.xls");
